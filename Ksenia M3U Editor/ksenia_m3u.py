...
class MainWindow(QMainWindow):
    ...
    def _setup_menu(self):
        ...
        replace_links_action = QAction("Заменить все ссылки", self)
        replace_links_action.triggered.connect(self._replace_links)
        links_menu.addAction(replace_links_action)
        
        replace_selected_links_action = QAction("Заменить выбранные ссылки", self)
        replace_selected_links_action.triggered.connect(self._replace_selected_links)
        ...
        remove_selected_broken_urls_action = QAction("Удалить выбранные битые ссылки", self)
